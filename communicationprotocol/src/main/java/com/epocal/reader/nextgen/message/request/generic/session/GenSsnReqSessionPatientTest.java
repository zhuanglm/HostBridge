...
public class GenSsnReqSessionPatientTest extends MsgPayload
{
    public static final MessageDescriptor MESSAGE_DESCRIPTOR = new MessageDescriptor(
            InterfaceType.NextGen, MessageClass.Generic, MessageGroup.Session,
            (byte) GenericSessionRequest.PatientTest.value);
    ...
    public GenSsnReqSessionPatientTest()
    {
        setMessageCode(MessageCodeType.NotDefined.value);
    }

    public GenSsnReqSessionPatientTest(MessageCodeType code)
    {
