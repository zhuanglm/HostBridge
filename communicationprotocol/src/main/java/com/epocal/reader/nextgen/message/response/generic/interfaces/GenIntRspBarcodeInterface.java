...
public class GenIntRspBarcodeInterface extends MsgPayload
{
    public static final MessageDescriptor MESSAGE_DESCRIPTOR = new MessageDescriptor(
            InterfaceType.NextGen, MessageClass.Generic, MessageGroup.Interface,
            GenericInterfaceResponse.Barcode.value);
    ...
    public GenIntRspBarcodeInterface()
    {
        setMessageCode(MessageCodeType.NotDefined.value);
    }

    public GenIntRspBarcodeInterface(byte errorCode)
    {
