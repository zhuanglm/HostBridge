...
public class GenSsnReqSessionReaderSettings extends MsgPayload
{
    public static final MessageDescriptor MESSAGE_DESCRIPTOR = new MessageDescriptor(
            InterfaceType.NextGen, MessageClass.Generic, MessageGroup.Session,
            (byte) GenericSessionRequest.ReaderSettings.value);
    ...
    public GenSsnReqSessionReaderSettings()
    {
        setMessageCode(MessageCodeType.NotDefined.value);
    }

    public GenSsnReqSessionReaderSettings(MessageCodeType code)
    {
