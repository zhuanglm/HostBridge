...
public class GenCfgRspSIBeQC extends MsgPayload {
    public static final MessageDescriptor MESSAGE_DESCRIPTOR = new MessageDescriptor(
            InterfaceType.NextGen, MessageClass.Generic, MessageGroup.Configuration,
            GenericConfigurationResponse.SIBeQC.value);
    ...
    private EQCConfiguration mConfig;

    public EQCConfiguration getEQCConfig() {
        return mConfig;
    }

    public void setEQCConfig(EQCConfiguration mConfig) {
        this.mConfig = mConfig;
    }

    public GenCfgRspSIBeQC() {
        mConfig = new EQCConfiguration();
    }

    public GenCfgRspSIBeQC(MessageCodeType messageCode, byte respDetail) {
