...
public class GenCmdRspPerformDryCardCheck extends MsgPayload {
    public static final MessageDescriptor MESSAGE_DESCRIPTOR = new MessageDescriptor(
            InterfaceType.NextGen, MessageClass.Generic, MessageGroup.Command,
            GenericCommandResponse.PerformDryCard.value);
    ...
    public GenCmdRspPerformDryCardCheck() {
        setMessageCode(MessageCodeType.NotDefined.value);
    }

    public GenCmdRspPerformDryCardCheck(byte errorCode) {
