package com.epocal.reader.nextgen.message.request.test.ack;
...
public class TstAckReqAck extends MsgPayload
{
    public static final MessageDescriptor MESSAGE_DESCRIPTOR = new MessageDescriptor(
            InterfaceType.NextGen, MessageClass.Test, MessageGroup.Ack,
            (byte) TestAckRequest.Ack.value);
