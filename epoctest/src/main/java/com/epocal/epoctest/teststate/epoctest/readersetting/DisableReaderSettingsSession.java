...
public class DisableReaderSettingsSession extends TestState {
    public DisableReaderSettingsSession() {
    }
    ...
    public IEventEnum onEventPreHandle(TestStateDataObject stateDataObject) {
        ...
        if (message.getDescriptor().getMsgClass() == MessageClass.Generic &&
            ...
            return TestStateEventEnum.ReaderEQC;
        }
        return super.onEventPreHandle(stateDataObject);
    }

    private boolean sendMessageToReader(TestStateDataObject stateDataObject) {
        GenSsnReqSessionReaderSettings req = new GenSsnReqSessionReaderSettings(GenSsnReqSessionReaderSettings.MessageCodeType.Disable);
