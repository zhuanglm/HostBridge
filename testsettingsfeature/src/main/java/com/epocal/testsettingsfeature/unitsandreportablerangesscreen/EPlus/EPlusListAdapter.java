...
class EPlusListAdapter extends BaseAdapter {

    private Context mContext;
    private ArrayList<Analyte> mAnalytes;
    private TextView mAnalyteName, mAnalyteUnit, mReportableHigh, mReportableLow;
    private EPlusFragment mEPlusFragment;

    EPlusListAdapter(Context context, ArrayList<Analyte> analytes, EPlusFragment ePlusFragment) {
        super();
        mContext = context;
        mAnalytes = analytes;
        mEPlusFragment = ePlusFragment;
    }
    ...
    public View getView(int position, View view, ViewGroup parent) {
        if (view == null) {
            ...
            view = layoutInflater.inflate(R.layout.adapter_e_settings_list_item, parent, false);
        }
