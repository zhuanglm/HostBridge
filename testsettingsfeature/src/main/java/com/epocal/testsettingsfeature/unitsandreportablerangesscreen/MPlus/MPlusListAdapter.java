...
class MPlusListAdapter extends BaseAdapter {

    private Context mContext;
    private ArrayList<Analyte> mAnalytes;
    private TextView mAnalyteName, mAnalyteUnit, mReportableHigh, mReportableLow;
    private MPlusFragment mPlusFragment;

    MPlusListAdapter(Context context, ArrayList<Analyte> analytes, MPlusFragment mPlusFragment) {
        super();
        mContext = context;
        mAnalytes = analytes;
        this.mPlusFragment = mPlusFragment;
    }
    ...
    public View getView(int position, View view, ViewGroup parent) {
        if (view == null) {
            ...
            view = layoutInflater.inflate(R.layout.adapter_m_settings_list_item, parent, false);
        }
