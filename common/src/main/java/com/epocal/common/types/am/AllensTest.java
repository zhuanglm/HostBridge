...
public enum AllensTest {
     ...
     */
    public static AllensTest convert(int value) {
        int enumIndex = Integer.MAX_VALUE;

        for (AllensTest rc : AllensTest.values()) {
            if (rc.value == value) {
                enumIndex = rc.index;
                break;
            }
        ...
        return AllensTest.values()[enumIndex];
    }

    public static AllensTest fromInt(int i) {
        return convert(i);
    }
