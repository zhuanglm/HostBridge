...
public enum FluidType {
     ...
     */
    public static FluidType convert(int value) {
        int enumIndex = Integer.MAX_VALUE;

        for (FluidType rc : FluidType.values()) {
            if (rc.value == value) {
                enumIndex = rc.index;
                break;
            }
        ...
        if (enumIndex == Integer.MAX_VALUE) {
            return FluidType.ENUM_UNINITIALIZED;
        }

        return FluidType.values()[enumIndex];
    }
